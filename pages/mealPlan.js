...
export default function Home() {
  ...
  return (
    <>
      {mealPlan?.length &&
        mealPlan.map((dayMeal, meal_index) => (
          <Row key={meal_index}>
            <Col
              xs={1}
              style={{
                  ...
                  {meal.recipe.label.length > 0 ? (
                    <Card
                      ...
                      style={{
                        ...
                        padding: "15px",
                        boxShadow:
                          "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 2px 5px 0 rgba(0, 0, 0, 0.19)",
                      }}
                      onClick={() => handleView(meal.recipe.uri)}
                    >
                      <h6 style={{ fontWeight: "bold", color: "#7FB237" }}>
                        {meal.recipe.label}
                      </h6>
                      <Row>
                        <Col
                        ...
                        <Col>
                          ...
                          >
                            <div>
                              ...
                              >
                                {Math.round(
                                  meal.recipe.calories / meal.recipe.yield
                                )}{" "}
                                kcal
                              </em>
                            </div>
      ...
      >
        <Button
          primary
          onClick={handleReset}
          style={{ backgroundColor: "#DD5746", border: "0px" }}
        >
          Reset the plan
        </Button>
      </div>
